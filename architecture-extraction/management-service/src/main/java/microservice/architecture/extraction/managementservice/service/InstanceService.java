package microservice.architecture.extraction.managementservice.service;
...
public class InstanceService {
    ...
    private microservice.architecture.extraction.managementservice.model.entity.Service addService(ServiceDto serviceDto) {
        microservice.architecture.extraction.managementservice.model.entity.Service service
                = new microservice.architecture.extraction.managementservice.model.entity.Service(
                        null,
                        serviceDto.getTitle(),
